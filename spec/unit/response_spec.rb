  ...
  describe '#redirect_url' do
    ...
    context 'when env is :test' do
      ...
      it 'returns a test redirect url' do
        expect(subject).to eq "https://go.test.idnow.de/#{IdnowRuby.company_id}/identifications/#{transaction_number}"
      end
    end
    context 'when env is :live' do
      ...
      it 'returns a live redirect url' do
        expect(subject).to eq "https://go.idnow.de/#{IdnowRuby.company_id}/identifications/#{transaction_number}"
      end
    end
  end
end
